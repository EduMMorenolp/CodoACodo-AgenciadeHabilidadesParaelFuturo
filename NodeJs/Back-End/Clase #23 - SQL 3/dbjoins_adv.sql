...
--
-- Servidor: localhost
-- Tiempo de generación: 28-05-2024 a las 03:40:42
...
INSERT INTO `materias` (`id`, `nombre`, `id_alumnos`) VALUES
(1, 'Matemáticas', 1001),
(2, 'Historia', 1001),
(3, 'Física', 1003),
(4, 'Química', 1003),
...
--
ALTER TABLE `materias`
  ADD CONSTRAINT `materias_ibfk_1` FOREIGN KEY (`id_alumnos`) REFERENCES `alumnos` (`legajo`);
COMMIT;
